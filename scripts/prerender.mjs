...
const ROUTES = [
  ...
  },
  {
    ...
    ar: { title: "الأسعار | GastroHub", description: "ثلاث خطط أسعار لمنصة مطاعم GastroHub: ديجيتال (300 € لمرة واحدة زائد 25 € شهرياً)، أو الانطلاقة (50 € شهرياً)، أو الباقة الشاملة (75 € شهرياً، مع جهاز لوحي وطابعة)." },
  },
  {
    path: "/faq",
